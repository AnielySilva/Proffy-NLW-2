...
function TeacherForm() {
    ...
    function setScheduleItemValue(position: number, field: string, value:string) {
        const updateedScheduleItems = scheduleItems.map((scheduleItem, index) => {
            if (index === position) {
        ...
        setScheduleItems(updateedScheduleItems);
    }
    ...
    return (
        <div id="page-teacher-form" className="container">
            <PageHeader
                ...
                description="O primeiro passo é preencher o formulário de incrição"
            />
            ...
            <main>
                <form onSubmit={handleCreateClass}>
                    <fieldset>
                        ...
                        <Textarea name="bio" label="Biografica" value={bio} onChange={(e) => { setBio(e.target.value) }} />
                    </fieldset>
